<html lang="ru">
  ...
  <body>
    ...
    <main>
      <article>
        <section class="mainpage" id="mainpage">
          ...
          ?>
          <p>Мне 19 лет, я учусь на 2 курсе Московского политехнического универистета по специальности "Прикладная информатика"</p>
        </section>
    ...
    <footer class="foot" id="foot">
      <div>
      <h2>Мои контакты:</h2>
      <p>Телефон: <a href="tel:+7 (936) 556-32-32">+7 (996) 476-17-90</a></p>

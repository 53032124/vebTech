<html lang="ru">
  ...
  <header class="head" id="head">
      <p class="page-title"><h1>Вакансии</h1></p>
...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "Вакансия: " . $row["название_вакансии"] . "<br>";
        echo "Требуемый стаж работы: " . $row["стаж_работы"] . "<br>";
        // Продолжайте выводить остальные поля...
        echo "<br>";
    }
} else {
